...
public class JdbcProductDao implements IProductDao {
	...
	{
		System.out.println("JDBC kullanilarak urun eklendi.");
	}

	@Override
	public void update(Product product) 
	{
		System.out.println("JDBC kullanilarak urun guncellendi.");
	}

	@Override
	public void delete(Product product) 
	{
		System.out.println("JDBC kullanilarak urun silindi.");
	}
